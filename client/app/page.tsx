...
export default function HomePage() {
  return (
    <section className="relative flex min-h-[88vh] items-center justify-center overflow-hidden bg-[#f8f5f2] px-4 dark:bg-[#111111]">
      ...
      <div className="relative z-10 max-w-4xl text-center">
        ...
        <h1 className="mt-8 text-5xl font-extrabold leading-tight tracking-tight text-[#2d1b16] sm:text-6xl lg:text-7xl dark:text-white">
          Track Your Books.
          <br />
          Build Your Reading Habit.
        </h1>

        <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-[#6b7280] dark:text-slate-400">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Link href="/dashboard" className="group rounded-2xl bg-gradient-to-r from-[#9d6b61] to-[#74463a] px-8 py-4 text-lg font-semibold text-white shadow-[0_10px_30px_rgba(91,52,43,0.25)] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_18px_40px_rgba(91,52,43,0.35)] active:scale-95">
            Open Dashboard
          </Link>
        </div>

        <div className="mt-16 grid gap-6 sm:grid-cols-3">
          <div className="rounded-3xl border border-[#e7ddd5] bg-white/80 p-6 shadow-lg backdrop-blur-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl dark:border-[#2a2a2a] dark:bg-[#181818]/90">
            <h3 className="text-xl font-bold text-[#2d1b16] dark:text-white">
              Discover Books
            </h3>

            <p className="mt-3 text-sm leading-7 text-[#6b7280] dark:text-slate-400">
