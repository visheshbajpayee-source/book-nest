    ...
    <section className="relative flex min-h-[88vh] items-center justify-center overflow-hidden bg-[#f8f5f2] px-4 dark:bg-[#111111]">
      ...
      <div className="relative z-10 max-w-4xl text-center">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Link
            href="/dashboard"
            className="rounded-2xl border border-[#d8ccc5] bg-white/80 px-8 py-4 text-lg font-semibold text-[#5b342b] shadow-md backdrop-blur-md transition-all duration-300 hover:-translate-y-2 hover:bg-white hover:shadow-xl"
          >
            Open Dashboard
          </Link>
        </div>
