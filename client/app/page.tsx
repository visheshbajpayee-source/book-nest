...
export default function HomePage() {
  return (
    <section className="relative flex min-h-[88vh] items-center justify-center overflow-hidden bg-[#f8f5f2] px-4">
      ...
      <div className="relative z-10 max-w-4xl text-center">
        <div className="inline-flex items-center rounded-full border border-[#d8ccc5] bg-white/70 px-5 py-2 text-sm font-medium text-[#5b342b] shadow-sm backdrop-blur-md">
          Your Personal Reading Companion
        </div>

        <h1 className="mt-8 text-5xl font-extrabold leading-tight tracking-tight text-[#2d1b16] sm:text-6xl lg:text-7xl">
          Track Your Books.
          <br />
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-3">
          <div className="rounded-3xl border border-[#e7ddd5] bg-white/80 p-6 shadow-lg backdrop-blur-md transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
            <h3 className="text-xl font-bold text-[#2d1b16]">
              Discover Books
            </h3>
