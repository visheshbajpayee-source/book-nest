...
declare namespace ts {
    namespace server {
         ...
         * Currently this is only sent for '.ts' files.
         */
    ...
    interface UserPreferences {
        ...
        /** Determines whether we import `foo/index.ts` as "foo", "foo/index", or "foo/index.ts" */
    ...
    interface System {
        ...
        /**
         * A good implementation is node.ts' `crypto.createHash`. (https://nodejs.org/api/crypto.html#crypto_crypto_createhash_algorithm)
         */
        createHash?(data: string): string;
