declare module "node:child_process" {
    ...
    class ChildProcess implements EventEmitter {
         ...
         * ```
         *
         * And then the child script, `'sub.ts'` might look like this:
         *
         * ```js
         ...
         * const subprocess = fork('subprocess.ts');
         *
         ...
         * import { createServer } from 'node:net';
         * import { fork } from 'node:child_process';
         * const normal = fork('subprocess.ts', ['normal']);
         * const special = fork('subprocess.ts', ['special']);
         *
         ...
         * import { spawn } from 'node:child_process';
         *
         * const subprocess = spawn(process.argv[0], ['child_program.ts'], {
         *   detached: true,
         *   stdio: 'ignore',
         * });
         *
