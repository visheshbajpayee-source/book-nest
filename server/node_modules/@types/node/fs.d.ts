declare module "node:fs" {
     ...
     *
     * const data = new Uint8Array(Buffer.from('Hello Node.ts'));
     ...
     * import { writeFile } from 'node:fs';
     *
     * writeFile('message.txt', 'Hello Node.ts', 'utf8', callback);
     * ```
     *
    ...
    interface _GlobOptions<T extends Dirent | string> {
         ...
         * specifies paths to exclude. Note: Negation patterns (e.g., '!foo.ts') are
         * not supported.
         * @default undefined
         */
