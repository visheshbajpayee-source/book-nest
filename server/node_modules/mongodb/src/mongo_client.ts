...
export class MongoClient extends TypedEventEmitter<MongoClientEvents> implements AsyncDisposable {
   ...
   *
   * After the close method completes there should be no MongoClient related resources [ref-ed in Node.ts' event loop](https://docs.libuv.org/en/v1.x/handle.html#reference-counting).
